...
require (
	github.com/CharLemAznable/llmdriver/drivers/doubao v0.1.1
	github.com/CharLemAznable/llmdriver/drivers/hunyuan v0.1.1
	github.com/CharLemAznable/llmdriver/drivers/moonshot v0.1.1
	github.com/CharLemAznable/llmdriver/drivers/qwen v0.1.1
	github.com/CharLemAznable/llmdriver/drivers/zhipu v0.1.1
	github.com/CharLemAznable/llmdriver/llmhttp v0.1.1
)

require (
	github.com/BurntSushi/toml v1.3.2 // indirect
	github.com/CharLemAznable/gfx v0.8.3 // indirect
	github.com/CharLemAznable/llmdriver v0.1.1 // indirect
